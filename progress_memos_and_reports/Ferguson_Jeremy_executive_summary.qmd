...
This project provides a valuable resource to those in the video game industry as an excellent data source for database analysis and a useful assortment of research ideas related to the wrangled data. For more information about the database, the web scraping process, or the full report, please visit the GitHub repository linked above.
