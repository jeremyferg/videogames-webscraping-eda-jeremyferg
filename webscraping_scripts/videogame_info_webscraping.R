...
### The goal of this script is to webscrape video game release information from Wikipedia webpages.
### Information includes the game's title, publisher, release date, genre, gameplay mode, and series (if applicable).
### The script starts by defining several helper functions that assist in cleaning and organizing the data.
### These helper functions are used in the final webscrapping function

###########################
#####   GITHUB LINK   #####
###########################

# https://github.com/jeremyferg/videogames-webscraping-eda-jeremyferg.git
...
### START OF HELPER CLEANING FUNCTIONS FUNCTIONS ##
...
#This function is used to clean the publishers, genres, and modes variable
# inputs var and col_str must be specified
...
### END OF HELPER CLEANING FUNCTIONS FUNCTIONS ##
